   ...
   ### Steps for Hyperparameter Optimization
    ...
    1. **Define Sweep Configuration**:
      ...
      3. **Launch Agents:**:
         ...
         * The parallel coordinate plot below, generated from the W&B sweep, visualizes different runs with varying hyperparameter combinations for architecture, batch size, and learning rate. The resulting mIoU for each run is shown on the right.
